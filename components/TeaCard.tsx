...
export default function TeaCard({ blend }: TeaCardProps) {
  return (
    <div className="bg-white rounded-[16px] overflow-hidden p-3.5 shadow-md hover:shadow-xl transition-all duration-300 flex flex-col justify-between border border-black/5 hover:-translate-y-1">
      <div>
